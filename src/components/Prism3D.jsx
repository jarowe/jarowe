...
import { createPrismGeometry, glassVertexShader, glassFragmentShader } from '../utils/prismGeometry';
...
/* ── CUSTOM GLASS SHADER — imported from shared prismGeometry.js ── */
const glassVert = glassVertexShader;
const glassFrag = glassFragmentShader;
...
/* ═══════════ GEOMETRY HOOK (delegates to shared factory) ═══════════ */
function usePrismGeometry(shape) {
  return useMemo(() => createPrismGeometry(shape), [shape]);
}
