...
export default function MusicCell() {
    const { isPlaying, currentTrackIndex, currentTrack, tracks, togglePlay, handleNext, handlePrevious } = useAudio();
        ...
        <div className="bento-content music-suno-active">
            <div className="music-top">
                <div className="music-artwork-wrapper">
                    ...
                    {currentTrack?.platform && <PlatformBadge platform={currentTrack.platform} />}
                </div>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <div className="now-playing">NOW SPINNING</div>
                    {currentTrack?.platformUrl && (
                        <a href={currentTrack.platformUrl} target="_blank" rel="noreferrer" style={{ fontSize: '0.7rem', color: '#a1a1aa', textDecoration: 'none', borderBottom: '1px dotted #a1a1aa' }}>
