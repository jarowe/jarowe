...
export const PRISM_DEFAULTS = {
  ...
  entranceBeamExcitement: 1.0, // 0=calm beams on entrance, 1=full shake (multiplies responsiveness)
  exitBeamExcitement: 1.0,     // 0=calm beams on exit, 1=full shake (multiplies responsiveness)
